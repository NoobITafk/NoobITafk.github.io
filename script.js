...
.profile-review{margin-top:13px!important;padding-top:12px!important;border-top:1px solid #dedad1!important}.profile-review-head{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:12px!important}.profile-review-title{font:700 11px/1 'Space Grotesk','DM Sans',sans-serif!important}.profile-review-stars{display:flex!important;gap:2px!important;color:#c89119!important}.profile-review-stars svg{width:14px!important;height:14px!important}.profile-review-meta{display:flex!important;justify-content:flex-end!important;margin-top:8px!important}.review-open{display:inline-flex!important;align-items:center!important;gap:6px!important;padding:7px 9px!important;border:0!important;border-radius:9px!important;background:#efede7!important;color:#2c2c29!important;font:700 9px/1 'DM Sans',sans-serif!important;cursor:pointer!important}.review-open svg{width:12px!important;height:12px!important;color:#c89119!important}.review-open:hover{background:#e6eafc!important;color:#3f5ee8!important}
...
function addProfileReview(){
  ...
  box.innerHTML=`<div class="profile-review-head"><strong class="profile-review-title">${isEN?'Client reviews':'Відгуки клієнтів'}</strong><span class="profile-review-stars">${starSvg()}${starSvg()}${starSvg()}${starSvg()}${starSvg()}</span></div><div class="profile-review-meta"><button type="button" class="review-open"><span>${starSvg(false)}</span>${isEN?'Leave a review':'Залишити відгук'}</button></div>`;
